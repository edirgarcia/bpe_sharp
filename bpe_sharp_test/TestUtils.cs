...
namespace bpe_sharp_test
{
    public class TestUtils
    {
        ...
        public static Dictionary<string, double> ConvertToTrigramDictionary(double[] encoding)
        {
            Dictionary<string, double> encDict = new Dictionary<string, double>();
