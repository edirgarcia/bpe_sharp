...
namespace bpe_sharp_test
{
    public class TestUtils
    {
        ...
        public static Dictionary<string, int> ConvertToTrigramDictionary(int[] encoding)
        {
